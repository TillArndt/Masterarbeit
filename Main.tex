\documentclass[11pt,twoside,a4paper,headsepline]{scrbook}
\usepackage{amsmath}
\usepackage{color}
\usepackage{upgreek}
\usepackage{hyperref}
...
\def\addtotoc#1{%           preface, bibliography, etc. shall be in the
\cleardoublepage%         contents but without a chapter number
