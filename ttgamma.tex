...
The cross section of the \ttgamma process is calculated by multiplying $R$ with $\sigma_{\ttbar}$. The CMS result is shown in Equation \ref{eq_ttg_cros_restt} \cite{CMS-PAS-TOP-12-007} \todo{Better Value ?}.
